...
//var gameStats = `You have played ${gamesPlayed} times, and you have won ${winningTimes} times and lost ${losingTimes} times. <br>${continueGameMessage}` WHY DOESNT THE GAME STATS UPDATE
...
var playNormalGame = function (userName, guess) {
  ...
  var reversed = function () {
    ...
    if (guess == compChoice) {
      ...
      console.log(guess);
      message = `You chose ${guess}. <br>The computer chose ${compChoice}. <br>It's a draw. <br>You have played ${gamesPlayed} times, and you have won ${winningTimes} times and lost ${losingTimes} times. <br>${continueGameMessage}`;
  ...
  if (guess == compChoice) {
    ...
    console.log(compChoice);
    console.log(guess);
    var message = `You chose ${guess}. <br>The computer chose ${compChoice}. <br>It's a draw.<br>You have played ${gamesPlayed} times, and you have won ${winningTimes} times and lost ${losingTimes} times. <br>${continueGameMessage}`;
