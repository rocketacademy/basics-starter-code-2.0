...
var madLibsInputCreateMain = function (input) {
  ...
  // set instructions text
  var myOutputValue = 'Enter an adjective or type "create" to switch to create mode.';
  return myOutputValue;
};
...
var madLibsMultipleWordsMain = function (input) {
  ...
  if (multipleWordsMode == 'input') {
    ...
    var feedbackMessage = `
      You have added ${inputWords.join(', ')} to our list of adjectives.<br/><br/>Enter another list of adjectives separated by a space each or type "create" to switch to create mode.
    `;
...
var madLibsMultipleTypesMain = function (input) {
  ...
  if (multipleTypesMode == 'input') {
    ...
    // Create feedback for the user on input
    var feedbackMessage = `
      You have added ${inputWords.join(', ')} to our list of ${currWordType}.<br/><br/>
