...
var roadTripCostBaseMain = function (kilometers) {
  // Complete the Base: Road Trip Cost exercise below with roadTripCostBaseMain as the main function.
  var milesPerKm = 0.62;
  var fuelConsumptionRate = 9;
  var fuelCostPerLitres = 2.2;
  var miles = kilometers * milesPerKm;
  var fuelCost = (miles / fuelConsumptionRate) * fuelCostPerLitres;

  var returnMsg = `Fuel cost for ${kilometers}km is $ ${fuelCost.toFixed(2)}`;
  return returnMsg;
};
